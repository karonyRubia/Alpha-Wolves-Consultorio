      ...
      <div className="flex-1 h-full min-h-0 main-content-area">
        {isAdding ? (
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-100 h-full flex flex-col animate-in fade-in slide-in-from-right-4 duration-300 overflow-hidden medical-record-container">
            {/* Cabeçalho do Prontuário - Updated to Medical Blue */}
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <div className="p-6 space-y-8">
                ...
                <section className="space-y-4">
                  ...
                  <textarea 
                    className="w-full h-32 bg-blue-50/20 border border-blue-100 rounded-2xl p-4 text-sm focus:ring-2 focus:ring-blue-500 resize-none transition-all"
                ...
                <section className="space-y-6">
                  ...
                  <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 space-y-4 evolution-form no-print">
                      ...
                      {(['CONSULTA', 'EXAME', 'PROCEDIMENTO', 'OBSERVAÇÃO'] as const).map(type => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-tighter transition-all ${
                            newEvolution.type === type ? 'bg-blue-900 text-white shadow-lg' : 'bg-white text-slate-400 border border-slate-100'
                          }`}
                        >
                          {type}
                        </button>
                    ...
                    <textarea 
                      className="w-full bg-white border border-slate-200 rounded-2xl p-4 text-sm focus:ring-2 focus:ring-blue-900 h-32 resize-none"
                    ...
                    <button 
                      ...
                      className="w-full bg-cyan-600 text-white py-3 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-cyan-700 shadow-lg shadow-cyan-100"
                    >
                        ...
                        <div key={entry.id} className="relative group">
                          ...
                          <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all history-entry-card">
                            <div className="flex items-center justify-between mb-3">
                              <span className="text-[9px] font-black px-2.5 py-1 rounded-lg bg-blue-900 text-white uppercase tracking-widest">
                                {entry.type}
                              </span>
