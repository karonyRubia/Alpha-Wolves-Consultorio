  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-12">
      <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        {/* Header Updated to Alpha Gradient */}
        <div className="p-8 border-b alpha-gradient text-white flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-blue-100">Personalize a identidade do seu consultório.</p>
          </div>
          <div className="text-right">
             <span className="text-[10px] font-black uppercase tracking-widest text-blue-200">v2.0 Stable</span>
          </div>
        </div>
          ...
          <div className="pt-6">
            <button 
              ...
              className={`w-full py-4 rounded-2xl font-bold transition-all shadow-lg text-sm uppercase tracking-widest ${
                saved ? 'bg-cyan-500 text-white shadow-cyan-200' : 'bg-blue-900 text-white shadow-blue-200 hover:bg-blue-800 active:scale-[0.99]'
              }`}
            >
        ...
        <div className="p-8 bg-slate-50 border-t border-slate-100 flex flex-col items-center gap-4 text-center">
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm w-full max-w-xs">
            ...
            <a href="tel:18991362185" className="text-lg font-black text-blue-600 hover:text-blue-800 transition-colors">18 99136-2185</a>
          </div>
        </div>
      </div>
    </div>
